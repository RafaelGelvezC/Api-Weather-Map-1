...
const Card = ({loadingData, showData, weather, forecast, onClose}) => {

    var today = new Date();
    var day = today.getDate();
    var month = today.getMonth() + 1;   // +1 para que inicie en Enero 
    ...
    if(showData){
        url = "http://openweathermap.org/img/w/";   //Desde esta url obtenemos el icono
                ...
                showData === true ? (
                    ...
                    <div className="container">
                        <div className="card mb-3 mx-auto bg-dark text-light">
                            <button className="btnf" onClick={onClose}> x </button>
                            <div className="row g-0">
                                <div className="col-md-4">
                                    <h3 className="card-title">{weather.name}</h3>
                                    <p className="card-date">{date}</p>
                                    <h1 className="card-temp">{(weather.main.temp - 273.15).toFixed(1)}ºC</h1>  {/* Convertimos grados K a C */}
                                    <p className="card-desc"><img src={iconUrl} alt="icon"/>{weather.weather[0].description}</p>
                                    <img src="https://images.pexels.com/photos/3573382/pexels-photo-3573382.jpeg?auto=compress&cs=tinysrgb&w=1600" className="img-fluid rounded-start" alt="..."/>
                                </div>
                                <div className="col-md-8">
                                    ...
                                    <hr/>    {/* Con la etiqueta hr se genera la linea  */}
